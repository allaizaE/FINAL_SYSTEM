...
public class UserManual {
    ...
    private void body() {
        ...
        Logo.setIcon(new ImageIcon(UserManual.class.getResource("/project_images/SYSTEMLOGO 1.png")));
        ...
        MenuButton.setIcon(new ImageIcon(UserManual.class.getResource("/project_images/Signoutmyprofile.png")));
